...
from models.transformer.constants import LayerType
...
class GAT(torch.nn.Module):
    ...
    def __init__(self, num_of_layers, num_heads_per_layer, num_features_per_layer, add_skip_connection=True, bias=True,
        ...
        for i in range(num_of_layers):
            layer = GATLayer(
                num_in_features=num_features_per_layer * num_heads_per_layer,  # consequence of concatenation
                num_out_features=num_features_per_layer,
...
class GATLayer(torch.nn.Module):
    ...
    def __init__(self, num_in_features, num_out_features, num_of_heads, layer_type, concat=True, activation=nn.ELU(),
        ...
        self.fc = nn.Linear(num_out_features * num_of_heads, num_out_features)
        ...
        if layer_type == LayerType.IMP1:
            ...
            self.linear_proj = nn.Linear(num_out_features, num_of_heads * num_out_features, bias=False)
    ...
    def skip_concat_bias(self, attention_coefficients, in_nodes_features, out_nodes_features):
        ...
        if self.concat:
            out_nodes_features = self.fc(out_nodes_features)
...
class GATLayerImp3(GATLayer):
    ...
    def forward(self, data):
        ...
        in_nodes_features, edge_index = data[0], data[1]  # unpack data
    ...
    def aggregate_neighbors(self, nodes_features_proj_lifted_weighted, edge_index, in_nodes_features, num_of_nodes):
        ...
        out_nodes_features.scatter_add_(self.nodes_dim, trg_index_broadcasted.to(out_nodes_features.device),
                                        nodes_features_proj_lifted_weighted.to(out_nodes_features.dtype))
